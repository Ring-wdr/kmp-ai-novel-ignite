...
private object DesktopDatabaseHolder {
    val database: NovelIgniteDatabase by lazy {
        ...
        NovelIgniteDatabase(driver)
    }
}

fun openDesktopDatabase(): NovelIgniteDatabase = DesktopDatabaseHolder.database
